...
Leaf1 =new Image();
Leaf1 = allTypeOfLeaves[0] = "files/theme/fall-leaves/images/leaf.png";//path to the image you will use
Leaf2 =new Image();
Leaf2 = allTypeOfLeaves[1] ="files/theme/fall-leaves/images/leaf1.png";//you can have up to 3 different kind of leaves
Leaf3 =new Image();
Leaf3 = allTypeOfLeaves[2] ="files/theme/fall-leaves/images/leaf2.png";//possible to add more
